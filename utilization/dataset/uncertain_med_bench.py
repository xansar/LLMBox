...
class UncertainMedBench(MultipleChoiceDataset):
    ...
    instruction_dict = {
        'empec': "empec请你回答下面这道关于中文医学考试的单项选择题，你需要在选项中选出一个正确答案，直接给出正确答案的选项。\n\n【题目】：\n\"\"\"\n{{question}}{{'\n' + options if options}}\n\"\"\"\n\n请直接写出正确答案的选项。",
        'cmb_exam': "cmb_exam请你回答下面这道关于中文医学考试的单项选择题，你需要在选项中选出一个正确答案，直接给出正确答案的选项。\n\n【题目】：\n\"\"\"\n{{question}}{{'\n' + options if options}}\n\"\"\"\n\n请直接写出正确答案的选项。",
        'nlpec': "nlpec请你回答下面这道关于中文医学考试的单项选择题，你需要在选项中选出一个正确答案，直接给出正确答案的选项。\n\n【题目】：\n\"\"\"\n{{question}}{{'\n' + options if options}}\n\"\"\"\n\n请直接写出正确答案的选项。",
        'cnple_phar': "cnple_phar请你回答下面这道关于中文药学考试的单项选择题，你需要在选项中选出一个正确答案，直接给出正确答案的选项。\n\n【题目】：\n\"\"\"\n{{question}}{{'\n' + options if options}}\n\"\"\"\n\n请直接写出正确答案的选项。",
        'cnple_tcm': "cnple_tcm请你回答下面这道关于中文中药学考试的单项选择题，你需要在选项中选出一个正确答案，直接给出正确答案的选项。\n\n【题目】：\n\"\"\"\n{{question}}{{'\n' + options if options}}\n\"\"\"\n\n请直接写出正确答案的选项。",
        'tcm_bench': "tcm_bench请你回答下面这道关于中文中医考试的单项选择题，你需要在选项中选出一个正确答案，直接给出正确答案的选项。\n\n【题目】：\n\"\"\"\n{{question}}{{'\n' + options if options}}\n\"\"\"\n\n请直接写出正确答案的选项。",

        'dialmed': "dialmed请你回答下面这道关于问诊对话药物推荐的单项选择题，问诊对话中的关键药物被[MASK]符号掩盖，现在请你从几个候选药物中选择一个最有可能的药物填入[MASK]位置。直接给出正确答案的选项。\n\n【对话】：\n\"\"\"\n{{question}}\n\"\"\"\n【候选药物】{{'\n' + options if options}}\n\n请直接写出最有可能的药物的选项。",
        'rjua_disease': "rjua_disease请你回答下面这道关于疾病诊断的单项选择题，你需要基于病情陈述从几个候选诊断中选择一个最有可能的诊断，直接给出正确答案的选项。\n\n【病情陈述】：\n\"\"\"\n{{question}}\n\"\"\"\n【候选诊断】{{'\n' + options if options}}\n\n请直接写出最有可能的诊断的选项。",
        'tcmsd_tcm': "tcmsd_tcm请你回答下面这道关于中医辨证的单项选择题，你需要基于病历信息（病史、主诉、检查）从几个候选证候中选择一个最有可能的证候，直接给出正确答案的选项。\n\n【病历信息】：\n\"\"\"\n{{question}}\n\"\"\"\n【候选证候】{{'\n' + options if options}}\n\n请直接写出最有可能的证候的选项。",
        'tcmsd_wm': "tcmsd_wm请你回答下面这道关于疾病诊断的单项选择题，你需要基于病历信息（病史、主诉、检查）从几个候选诊断中选择一个最有可能的诊断，直接给出正确答案的选项。\n\n【病历信息】：\n\"\"\"\n{{question}}\n\"\"\"\n【候选诊断】{{'\n' + options if options}}\n\n请直接写出最有可能的诊断的选项。",
        'mvme': "mvme请你回答下面这道关于疾病诊断的单项选择题，你需要基于病历信息（一般资料、主诉、现病史、既往史、查体、辅助检查）从几个候选诊断中选择一个最有可能的诊断，直接给出正确答案的选项。\n\n【病历信息】：\n\"\"\"\n{{question}}\n\"\"\"\n【候选诊断】{{'\n' + options if options}}\n\n请直接写出最有可能的诊断的选项。",
    }
    instruction = ''
